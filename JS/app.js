...
for (var i = 0; i < itemDB.length; i++) {
    ...
    ChildDiv.className = "cartItem" + i;
    mainDiv.appendChild(ChildDiv);


var productBox = document.createElement("p");
productBox.id = "product" + i;
productBox.textContent = "name: " + itemDB[i].product;
ChildDiv.appendChild(productBox);


var descriptionBox = document.createElement("p");
descriptionBox.id = "description" + i;
descriptionBox.textContent = " description: " + itemDB[i].description;
ChildDiv.appendChild(descriptionBox);

var priceBox = document.createElement("p");
priceBox.id = "price" + i;
priceBox.textContent = " price: " + itemDB[i].price;
